// node_modules/.pnpm/chartist@1.4.0/node_modules/chartist/dist/index.js
var namespaces = {
...
function each(list, callback) {
  ...
  list[reverse ? "reduceRight" : "reduce"](
    (_, item, itemIndex) => callback(item, index2++, itemIndex),
    void 0
  );
}
  ...
  return function cardinalInterpolation(pathCoordinates, valueData) {
    ...
    if (!segments.length) {
      ...
      return SvgPath.join(segments.map(
        (segment) => cardinalInterpolation(segment.pathCoordinates, segment.valueData)
      ));
    } else {
...
var FixedScaleAxis = class extends Axis {
  ...
  constructor(axisUnit, data, chartRect, options) {
    ...
    const ticks = (options.ticks || times(
      divisor,
      (index2) => highLow.low + (highLow.high - highLow.low) / divisor * index2
    )).sort(
...
var PieChart = class extends BaseChart {
  ...
  */
  createChart(options) {
    ...
    data.series.forEach(
      (_, index2) => seriesGroups[index2] = svg.elem("g")
    );
    ...
    data.series.forEach((series, index2) => {
      ...
      seriesGroups[index2].addClass([
        (ref = options.classNames) === null || ref === void 0 ? void 0 : ref.series,
        seriesClassName || "".concat((ref1 = options.classNames) === null || ref1 === void 0 ? void 0 : ref1.series, "-").concat(alphaNumerate(index2))
      ].join(" "));
      ...
      if (options.showLabel) {
        ...
        if (interpolatedValue || interpolatedValue === 0) {
          if (options.preventOverlappingLabelOffset) {
            ...
            const length = String(normalizedData.labels[index2]).length;
